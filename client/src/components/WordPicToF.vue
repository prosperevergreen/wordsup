	...
	<div>
		<v-card outlined class="mb-2">
			...
			<v-card-text class="text-above-image">
				...
				<v-text-field readonly :error-messages="onErrorMsgEng" label="Word" :success-messages="onCorrectMsgEng" v-model="que" outlined rounded :class="textColor" class="centered-input-pic errorMsgEng"></v-text-field>
			</v-card-text>
